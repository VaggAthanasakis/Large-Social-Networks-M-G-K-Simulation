...
def simulate_queue(lambda_rate, xm ,alpha, num_jobs=10000000):
    ...
    for i in range(1, num_jobs):
        ...
        # if(i < 100):
            # print(i)
            # print("Arrival ", arrival_times[i])
            # print("Start ", start_times[i])
            # print("Finish ", finish_times[i])
            # print("response ", response_times[i])
